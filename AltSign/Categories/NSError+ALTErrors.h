...
extern NSErrorUserInfoKey const ALTAppleAPIRequestOperationErrorKey;
extern NSErrorUserInfoKey const ALTAppleAPIHTTPStatusCodeErrorKey;
extern NSErrorUserInfoKey const ALTAppleAPIResponseMIMETypeErrorKey;
